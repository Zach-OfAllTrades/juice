...
export const IconOnly: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
      <Button iconOnly size="sm" variant="secondary" aria-label="Search">
        <svg
          width="14"
          height="14"
          viewBox="0 0 24 24"
      ...
      <Button iconOnly size="md" variant="primary" aria-label="Add new item">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
      ...
      <Button iconOnly size="lg" variant="ghost" aria-label="Settings">
        <svg
          width="20"
          height="20"
          viewBox="0 0 24 24"
